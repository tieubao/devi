...
class ViewController: UIViewController, NumericKeypadDelegate {
    ...
    override func viewDidLoad() {
        ...
        dotButtonPressed = Defaults[DefaultsKeys.dotButtonPressed]
    ...
    func numberTapped(number: Int) {
        ...
        if dotButtonPressed == false && keypadString.characters.count > 5 { return }
        if dotButtonPressed && fractionDigits > 0 && keypadString.characters.count > 8 { return }
    ...
    func dotTapped() {
        ...
        if keypadString.characters.count > 7 { return }
    ...
    func updateViews() {
        ...
        Defaults[DefaultsKeys.dotButtonPressed] = dotButtonPressed
    }
